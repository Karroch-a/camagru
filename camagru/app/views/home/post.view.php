    ...
    <div class="post">
                    ...
                    <div class = "image">
                        ...
                        <div class = "new_like" id = "<?= $img['image_id']?>" ><?= $img['like_count']?> Likes</div>
                            <div onclick="deleteCmnt('');" class="fetchcmnt"><h6><?=$img['username']?></h6><span></span><i class="fa fa-trash fa-fw" aria-hidden="true" ></i></div>
                            <section class="okkk">
                        <div class="cmnt">
                            <div class="ikk">
                            <textarea aria-label="Add a comment…" placeholder="Add a comment…" class="text" id="textarea" autocomplete="off" autocorrect="off"></textarea>
                            <button onclick="cmnt('<?= $img['image_n']?>');" type="submit">Post</button>
                            <div>
                        </div>
                        </section>
                    </div>
